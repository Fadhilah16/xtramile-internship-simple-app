        ...
        <Container className="mt-5">
            <Row className="justify-content-md-center">
                <Col xs={4}>
                    ...
                    {success && !loading ? toastFunction("Success", "Student created successfully.", "green") : toastFunction("Failed", error.message, "red")}
                    <Card>
                        <Card.Title className="d-flex justify-content-center mt-3">Create Student</Card.Title>
                        <Card.Body>
                    {loading && spinner}
                        <Form noValidate >
                            ...
                            <Button onClick={formHandler} variant="primary" type="submit">
                                Create
                            </Button>
                        </Form>
                    </Card.Body>
